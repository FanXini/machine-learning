...
def pull_screenshot(path):
    global pictureNum
    path+=str(pictureNum)+".png"
    os.system("adb shell /system/bin/screencap -p /sdcard/autojump.png")
    os.system("adb pull /sdcard/autojump.png .")
    os.system("adb pull /sdcard/autojump.png {0}".format(path))
    pictureNum+=1

Path="E:/Users/fanxin/Desktop/Pictures1/"
def main():
    """
    主函数
    """
